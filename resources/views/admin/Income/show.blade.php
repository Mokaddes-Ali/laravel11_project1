    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            ...
            <a class="btn btn-primary btn-sm," href="{{ url('/invoice/create' , $row->paid_amount) }}">invoice</a>
            <a class="btn btn-secondary btn-sm," href="{{ url('/invoice/pdf' , $row->paid_amount) }}">pdf</a>
